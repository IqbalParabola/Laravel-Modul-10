            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <a href="<?php echo e(route('profile')); ?>" class="dropdown-item"> <i class="bi bi-person-fill me-2""></i>My Profile</a>
                        <hr>
...
<?php /**PATH C:\Users\USER\Desktop\Laravel-Modul-06\resources\views/layouts/nav.blade.php ENDPATH**/ ?>